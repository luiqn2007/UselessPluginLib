...
import static com.github.javaparser_new.ast.Node.Parsedness.UNPARSABLE;
import static com.github.javaparser_new.utils.PositionUtils.sortByBeginPosition;
import static com.github.javaparser_new.utils.Utils.isNullOrEmpty;
import static com.github.javaparser_new.utils.Utils.normalizeEolInTextBlock;
import static com.github.javaparser_new.utils.Utils.trimTrailingSpaces;
...
import com.github.javaparser_new.ast.ArrayCreationLevel;
...
import com.github.javaparser_new.ast.PackageDeclaration;
import com.github.javaparser_new.ast.body.AnnotationDeclaration;
import com.github.javaparser_new.ast.body.AnnotationMemberDeclaration;
...
import com.github.javaparser_new.ast.body.CompactConstructorDeclaration;
import com.github.javaparser_new.ast.body.ConstructorDeclaration;
import com.github.javaparser_new.ast.body.EnumConstantDeclaration;
import com.github.javaparser_new.ast.body.EnumDeclaration;
import com.github.javaparser_new.ast.body.FieldDeclaration;
import com.github.javaparser_new.ast.body.InitializerDeclaration;
import com.github.javaparser_new.ast.body.MethodDeclaration;
import com.github.javaparser_new.ast.body.Parameter;
import com.github.javaparser_new.ast.body.ReceiverParameter;
...
import com.github.javaparser_new.ast.comments.BlockComment;
import com.github.javaparser_new.ast.comments.Comment;
import com.github.javaparser_new.ast.comments.JavadocComment;
import com.github.javaparser_new.ast.comments.LineComment;
import com.github.javaparser_new.ast.expr.AnnotationExpr;
import com.github.javaparser_new.ast.expr.ArrayAccessExpr;
import com.github.javaparser_new.ast.expr.ArrayCreationExpr;
import com.github.javaparser_new.ast.expr.ArrayInitializerExpr;
import com.github.javaparser_new.ast.expr.AssignExpr;
import com.github.javaparser_new.ast.expr.BinaryExpr;
import com.github.javaparser_new.ast.expr.BooleanLiteralExpr;
import com.github.javaparser_new.ast.expr.CastExpr;
import com.github.javaparser_new.ast.expr.CharLiteralExpr;
import com.github.javaparser_new.ast.expr.ClassExpr;
import com.github.javaparser_new.ast.expr.ConditionalExpr;
import com.github.javaparser_new.ast.expr.DoubleLiteralExpr;
import com.github.javaparser_new.ast.expr.EnclosedExpr;
import com.github.javaparser_new.ast.expr.Expression;
import com.github.javaparser_new.ast.expr.FieldAccessExpr;
import com.github.javaparser_new.ast.expr.InstanceOfExpr;
import com.github.javaparser_new.ast.expr.IntegerLiteralExpr;
import com.github.javaparser_new.ast.expr.LambdaExpr;
import com.github.javaparser_new.ast.expr.LongLiteralExpr;
import com.github.javaparser_new.ast.expr.MarkerAnnotationExpr;
import com.github.javaparser_new.ast.expr.MemberValuePair;
import com.github.javaparser_new.ast.expr.MethodCallExpr;
import com.github.javaparser_new.ast.expr.MethodReferenceExpr;
import com.github.javaparser_new.ast.expr.Name;
import com.github.javaparser_new.ast.expr.NameExpr;
import com.github.javaparser_new.ast.expr.NormalAnnotationExpr;
import com.github.javaparser_new.ast.expr.NullLiteralExpr;
import com.github.javaparser_new.ast.expr.ObjectCreationExpr;
import com.github.javaparser_new.ast.expr.PatternExpr;
import com.github.javaparser_new.ast.expr.SimpleName;
import com.github.javaparser_new.ast.expr.SingleMemberAnnotationExpr;
import com.github.javaparser_new.ast.expr.StringLiteralExpr;
import com.github.javaparser_new.ast.expr.SuperExpr;
import com.github.javaparser_new.ast.expr.SwitchExpr;
import com.github.javaparser_new.ast.expr.TextBlockLiteralExpr;
import com.github.javaparser_new.ast.expr.ThisExpr;
...
import com.github.javaparser_new.ast.modules.ModuleDeclaration;
import com.github.javaparser_new.ast.modules.ModuleExportsDirective;
import com.github.javaparser_new.ast.modules.ModuleOpensDirective;
import com.github.javaparser_new.ast.modules.ModuleProvidesDirective;
import com.github.javaparser_new.ast.modules.ModuleRequiresDirective;
import com.github.javaparser_new.ast.modules.ModuleUsesDirective;
import com.github.javaparser_new.ast.nodeTypes.NodeWithName;
import com.github.javaparser_new.ast.nodeTypes.NodeWithTraversableScope;
import com.github.javaparser_new.ast.nodeTypes.NodeWithTypeArguments;
import com.github.javaparser_new.ast.nodeTypes.NodeWithVariables;
import com.github.javaparser_new.ast.nodeTypes.SwitchNode;
import com.github.javaparser_new.ast.stmt.AssertStmt;
import com.github.javaparser_new.ast.stmt.BlockStmt;
import com.github.javaparser_new.ast.stmt.BreakStmt;
import com.github.javaparser_new.ast.stmt.CatchClause;
import com.github.javaparser_new.ast.stmt.ContinueStmt;
import com.github.javaparser_new.ast.stmt.DoStmt;
import com.github.javaparser_new.ast.stmt.EmptyStmt;
import com.github.javaparser_new.ast.stmt.ExplicitConstructorInvocationStmt;
import com.github.javaparser_new.ast.stmt.ExpressionStmt;
import com.github.javaparser_new.ast.stmt.ForEachStmt;
import com.github.javaparser_new.ast.stmt.ForStmt;
import com.github.javaparser_new.ast.stmt.IfStmt;
import com.github.javaparser_new.ast.stmt.LabeledStmt;
import com.github.javaparser_new.ast.stmt.LocalClassDeclarationStmt;
import com.github.javaparser_new.ast.stmt.LocalRecordDeclarationStmt;
import com.github.javaparser_new.ast.stmt.ReturnStmt;
import com.github.javaparser_new.ast.stmt.Statement;
import com.github.javaparser_new.ast.stmt.SwitchEntry;
import com.github.javaparser_new.ast.stmt.SwitchStmt;
import com.github.javaparser_new.ast.stmt.SynchronizedStmt;
import com.github.javaparser_new.ast.stmt.ThrowStmt;
import com.github.javaparser_new.ast.stmt.TryStmt;
import com.github.javaparser_new.ast.stmt.UnparsableStmt;
import com.github.javaparser_new.ast.stmt.WhileStmt;
import com.github.javaparser_new.ast.stmt.YieldStmt;
import com.github.javaparser_new.ast.type.ArrayType;
import com.github.javaparser_new.ast.type.ClassOrInterfaceType;
import com.github.javaparser_new.ast.type.IntersectionType;
import com.github.javaparser_new.ast.type.PrimitiveType;
import com.github.javaparser_new.ast.type.ReferenceType;
import com.github.javaparser_new.ast.type.Type;
import com.github.javaparser_new.ast.type.TypeParameter;
import com.github.javaparser_new.ast.type.UnionType;
...
import com.github.javaparser_new.ast.type.WildcardType;
import com.github.javaparser_new.ast.visitor.Visitable;
import com.github.javaparser_new.ast.visitor.VoidVisitor;
import com.github.javaparser_new.printer.configuration.ConfigurationOption;
import com.github.javaparser_new.printer.configuration.DefaultConfigurationOption;
import com.github.javaparser_new.printer.configuration.DefaultPrinterConfiguration.ConfigOption;
