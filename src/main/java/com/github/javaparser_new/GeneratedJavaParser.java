...
import com.github.javaparser_new.utils.*;
import static com.github.javaparser_new.JavaToken.INVALID;
...
import static com.github.javaparser_new.ast.NodeList.*;
import static com.github.javaparser_new.GeneratedJavaParser.*;
import static com.github.javaparser_new.Range.*;
import static com.github.javaparser_new.Position.*;
import static com.github.javaparser_new.ast.type.ArrayType.*;
import static com.github.javaparser_new.GeneratedJavaParserTokenManagerBase.*;
import static com.github.javaparser_new.ast.stmt.SwitchEntry.Type.*;
...
{if ("" != null) return new ClassOrInterfaceDeclaration(range(begin, token()), modifier.modifiers, modifier.annotations, isInterface, name, typePar.list, extList, impList, members);}
    throw new IllegalStateException ("Missing return statement in function");
}
 ...
 * }</pre>
 */
  final public NodeList<ClassOrInterfaceType> TypeBound() throws ParseException {NodeList<ClassOrInterfaceType> ret = emptyNodeList();
    ClassOrInterfaceType cit;
    jj_consume_token(EXTENDS);
    cit = AnnotatedClassOrInterfaceType();
ret.add(cit);
 ...
 * }</pre>
 */
  final public NodeList<BodyDeclaration<?>> ClassOrInterfaceBody() throws ParseException {NodeList<BodyDeclaration<?>> ret = emptyNodeList();
    BodyDeclaration member;
    jj_consume_token(LBRACE);
    label_11:
    while (true) {
 ...
 */
  final public NodeList<BodyDeclaration<?>> RecordBody() throws ParseException {NodeList<BodyDeclaration<?>> ret = emptyNodeList();
    BodyDeclaration member;
    jj_consume_token(LBRACE);
    label_12:
    while (true) {
 ...
 * }</pre>
 */
  final public CompactConstructorDeclaration CompactConstructorDeclaration(ModifierHolder modifier) throws ParseException {RangedList<TypeParameter> typeParameters = new RangedList<TypeParameter>(emptyNodeList());
    SimpleName name;
 ...
 * }</pre>
 */
  final public ArrayInitializerExpr ArrayInitializer() throws ParseException {NodeList<Expression> values = emptyNodeList();
    Expression val;
    JavaToken begin;
    jj_consume_token(LBRACE);
begin=token();
 ...
 * }</pre>
 */
  final public MethodDeclaration MethodDeclaration(ModifierHolder modifier) throws ParseException {RangedList<TypeParameter> typeParameters = new RangedList<TypeParameter>(emptyNodeList());
    Type type;
    SimpleName name;
    Pair<NodeList<Parameter>, ReceiverParameter> parameters = new Pair<NodeList<Parameter>, ReceiverParameter>(emptyNodeList(), null);
    ArrayBracketPair arrayBracketPair;
 ...
 * }</pre>
 */
  final public Pair<NodeList<Parameter>, ReceiverParameter> Parameters() throws ParseException {NodeList<Parameter> ret = emptyNodeList();
    Parameter par;
 ...
 * }</pre>
 */
  final public ConstructorDeclaration ConstructorDeclaration(ModifierHolder modifier) throws ParseException {RangedList<TypeParameter> typeParameters = new RangedList<TypeParameter>(emptyNodeList());
    SimpleName name;
    Pair<NodeList<Parameter>, ReceiverParameter> parameters = new Pair<NodeList<Parameter>, ReceiverParameter>(emptyNodeList(), null);
    NodeList<ReferenceType> throws_ = emptyNodeList();
    ExplicitConstructorInvocationStmt exConsInv = null;
 ...
 * }</pre>
 */
  final public NodeList<Statement> Statements() throws ParseException {NodeList<Statement> ret = emptyNodeList();
    Statement stmt;
    label_23:
    while (true) {
      if (jj_2_24(2)) {
 ...
 * }<pre>
 */
  final public Type Type(NodeList<AnnotationExpr> annotations) throws ParseException {Type ret;
 ...
 * }<pre>
 */
  final public PatternExpr PatternExpression() throws ParseException {ReferenceType type;
    SimpleName name;
    type = AnnotatedReferenceType();
    name = SimpleName();
{if ("" != null) return new PatternExpr(range(type, token()), type, name);}
    throw new IllegalStateException ("Missing return statement in function");
}
 ...
 * }</pre>
 */
  final public NodeList<Expression> Arguments() throws ParseException {NodeList<Expression> ret = emptyNodeList();
    jj_consume_token(LPAREN);
    switch (jj_ntk == -1 ? jj_ntk_f() : jj_ntk) {
    case BOOLEAN:
    case BYTE:
 ...
 * }</pre>
 */
  final public NodeList<Expression> ArgumentList() throws ParseException {NodeList<Expression> ret = emptyNodeList();
    Expression expr;
    expr = Expression();
ret.add(expr);
    label_43:
 ...
 * }</pre>
 */
  final public BlockStmt Block() throws ParseException {NodeList<Statement> stmts = emptyNodeList();
    JavaToken begin;
    jj_consume_token(LBRACE);
begin=token();
    try {
 ...
 * }<pre>
 */
  final public TryStmt TryStatement() throws ParseException {NodeList<Expression> resources = emptyNodeList();
    BlockStmt tryBlock;
 ...
 * }<pre>
 */
  final public NodeList<AnnotationExpr> Annotations() throws ParseException {NodeList<AnnotationExpr> annotations = new NodeList<AnnotationExpr>();
 ...
 * }<pre>
 */
  final public Expression MemberValueArrayInitializer() throws ParseException {NodeList<Expression> ret = emptyNodeList();
    Expression member;
    JavaToken begin;
    jj_consume_token(LBRACE);
begin=token();
 ...
 * }<pre>
 */
  final public AnnotationDeclaration AnnotationTypeDeclaration(ModifierHolder modifier) throws ParseException {SimpleName name;
    NodeList<BodyDeclaration<?>> members = emptyNodeList();
    JavaToken begin = modifier.begin;
    jj_consume_token(AT);
begin=orIfInvalid(begin, token());
...
{if ("" != null) return new AnnotationDeclaration(range(begin, token()), modifier.modifiers, modifier.annotations, name, members);}
    throw new IllegalStateException ("Missing return statement in function");
}
 ...
 * }<pre>
 */
  final public NodeList<BodyDeclaration<?>> AnnotationTypeBody() throws ParseException {NodeList<BodyDeclaration<?>> ret = emptyNodeList();
    BodyDeclaration member;
    jj_consume_token(LBRACE);
    label_56:
    while (true) {
...
JavaToken begin = orIfInvalid(modifier.begin, type);
        {if ("" != null) return new AnnotationMemberDeclaration(range(begin, token()), modifier.modifiers, modifier.annotations, type, name, defaultVal);}
    throw new IllegalStateException ("Missing return statement in function");
}
 ...
 * }<pre>
 */
  final public ModuleDirective ModuleDirective() throws ParseException {ModifierHolder modifiers;
    Name name;
    Name tmpName;
...
directives = add(directives, directive);
    ...
    jj_consume_token(RBRACE);
{if ("" != null) return new ModuleDeclaration(range(begin, token()), modifier.annotations, name, open, directives);}
    throw new IllegalStateException ("Missing return statement in function");
}
...
{if ("" != null) return ret;}
  ...
  private boolean jj_3R_103()
 {
    ...
    jj_lookingAhead = false;
    if (!jj_semLA || jj_3R_165()) return true;
    if (jj_scan_token(GT)) return true;
    if (jj_scan_token(GT)) return true;
    return false;
  }
  ...
  private boolean jj_3R_89()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0
,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x56043ffe,0x0,0x0,0x40000ffe,0x40000ffe,0x0,0x40000ffe,0x40000ffe,0x0,0x0,0x0,0x40000ffe,0x40000ffe,0x0,0x40000ffe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000ffe,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x56043ffe,0x0,0x0,0x56043ffe,0x0,0x0,0x40000ffe,0x0,0x0,0x0,0x40000ffe,0x0,0x0,0x56043ffe,0x0,0x40000ffe,0x0,0x16043000,0x40000ffe,0x0,0x0,0x0,0x0,0x0,0x16043000,0x0,0x56043ffe,0x0,0x0,0x0,0x40000ffe,0x56043ffe,0x0,0x0,0x56043fff,0x0,0x56043fff,0x0,0x56043ffe,0x0,0x0,0x56043ffe,0x0,0x0,0x0,0x0,0x56043ffe,0x0,0x0,0x56043ffe,0x56043ffe,0x56043ffe,0x56043ffe,0x56043ffe,0x0,0x40000ffe,0x40000ffe,0x56043ffe,0x0,0x0,0x0,0x0,0x56043ffe,0x40000ffe,0x0,0x56043ffe,0x56043ffe,0x0,0x40000ffe,0x40000ffe,0x0,0x40000ffe,0x0,0x0,0x8,0x0,0x8,0x0,0x6c4,0x20,0x6c4,0x56043ffe,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x880,0x880,0x880,0x0,0x0,0x200,0x800,0x0,0x4000,0x0,0x0,0x4000,0x0,0x100,0x100,0x0,0x800,0x100,0x4888,0x4888,0x80,0x800,0x2,0x8,0x100,0x0,0x0,0x4888,0x4888,0x4888,0x4888,0x0,0x4800,0x4800,0x4000,0x100,0x0,0x0,0x4800,0x4800,0x100,0x2000,0x820,0x3c01880a,0x3c01880a,0x100,0x4000,0x820,0x100,0x0,0x88,0x800,0x100,0x800,0x100,0x100,0xc00,0x4000,0x100,0x0,0x4000,0x4000,0x4802,0x0,0x0,0x0,0x800,0x100,0x20800,0x20000,0x0,0x0,0x0,0x0,0x0,0x4000,0x0,0x81000,0x83000,0x2000,0x20000,0x2000000,0x1000000,0x0,0x0,0x0,0x900000,0x900000,0x800,0x0,0x604000,0x604000,0x0,0x30000000,0x30000000,0xc0000000,0xc0000000,0x30000000,0x3c018802,0x18000,0x18000,0x802,0xc000000,0x0,0x0,0x4000,0x2,0x4000,0x0,0x1200,0x4,0x3c018802,0x4000,0x0,0x2,0x2,0x0,0x200,0x4000,0x2,0x0,0x220,0x0,0x0,0x3c018802,0x100,0x4000,0x822,0x0,0x3c018802,0x8,0x0,0xc00088a,0x40000,0xc00088a,0x100,0x3c01880a,0xc002000,0xc002000,0x8000802,0x0,0x0,0x100,0x0,0x3c01880a,0xc0000,0x0,0x3c018802,0x3c018802,0x3c018802,0x3c018882,0x3c018802,0x100,0x0,0x0,0x3c018802,0x2,0x0,0x0,0x0,0x802,0x0,0x100,0x3c01880a,0x3c01880a,0x100,0x880,0x880,0x0,0x800,0x0,0x100,0x0,0x100,0x0,0x100,0x0,0x0,0x0,0x4802,0x800,};
	}
	private static void jj_la1_init_4() {
	   jj_la1_4 = new int[] {0x0,0x0,0x0,0x80000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe0,0xffe0,0x0,0x0,0x0,0x2,0x4,0x1,0x0,0x0,0x0,0x0,0x40000,0x40000,0x10,0x0,0x0,0x8,0x8,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe0,0xffe0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
