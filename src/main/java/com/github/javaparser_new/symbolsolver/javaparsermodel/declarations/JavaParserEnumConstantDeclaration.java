...
public class JavaParserEnumConstantDeclaration implements ResolvedEnumConstantDeclaration {
    ...
    private com.github.javaparser_new.ast.body.EnumConstantDeclaration wrappedNode;

    public JavaParserEnumConstantDeclaration(com.github.javaparser_new.ast.body.EnumConstantDeclaration wrappedNode, TypeSolver typeSolver) {
     ...
     */
    public com.github.javaparser_new.ast.body.EnumConstantDeclaration getWrappedNode() {
        return wrappedNode;
    }
