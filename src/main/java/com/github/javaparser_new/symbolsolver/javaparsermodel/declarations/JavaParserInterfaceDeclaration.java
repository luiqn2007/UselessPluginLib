...
import com.github.javaparser_new.resolution.declarations.ResolvedInterfaceDeclaration;
...
public class JavaParserInterfaceDeclaration extends AbstractTypeDeclaration
    ...
    public Set<ResolvedMethodDeclaration> getDeclaredMethods() {
        ...
        for (BodyDeclaration<?> member : wrappedNode.getMembers()) {
            if (member instanceof com.github.javaparser_new.ast.body.MethodDeclaration) {
                methods.add(new JavaParserMethodDeclaration((com.github.javaparser_new.ast.body.MethodDeclaration) member, typeSolver));
            }
        }
        return methods;
    }
