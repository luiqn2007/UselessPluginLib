...
import com.github.javaparser_new.resolution.declarations.ResolvedEnumConstantDeclaration;
import com.github.javaparser_new.resolution.declarations.ResolvedEnumDeclaration;
...
import com.github.javaparser_new.resolution.types.parametrization.ResolvedTypeParametersMap;
import com.github.javaparser_new.symbolsolver.core.resolution.Context;
import com.github.javaparser_new.symbolsolver.core.resolution.MethodUsageResolutionCapability;
import com.github.javaparser_new.symbolsolver.core.resolution.TypeVariableResolutionCapability;
...
import com.github.javaparser_new.symbolsolver.logic.AbstractTypeDeclaration;
import com.github.javaparser_new.symbolsolver.logic.MethodResolutionCapability;
...
import com.github.javaparser_new.symbolsolver.model.typesystem.LazyType;
import com.github.javaparser_new.symbolsolver.model.typesystem.ReferenceTypeImpl;
import com.github.javaparser_new.symbolsolver.reflectionmodel.ReflectionFactory;
...
public class JavaParserEnumDeclaration extends AbstractTypeDeclaration
    ...
    public SymbolReference<ResolvedMethodDeclaration> solveMethod(String name, List<ResolvedType> argumentsTypes,
        ...
        if (name.equals("values") && argumentsTypes.isEmpty()) {
            return SymbolReference.solved(new ValuesMethod(this, typeSolver));
        }
        if (name.equals("valueOf") && argumentsTypes.size() == 1) {
            ...
            if (argument.isReferenceType() && "java.lang.String".equals(argument.asReferenceType().getQualifiedName())) {
                return SymbolReference.solved(new ValueOfMethod(this, typeSolver));
            }
        }
