...
import com.github.javaparser_new.ast.body.CallableDeclaration;
...
public class CallableDeclarationMetaModel extends BodyDeclarationMetaModel {
    ...
    CallableDeclarationMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, CallableDeclaration.class, "CallableDeclaration", "com.github.javaparser_new.ast.body", true, true);
    }
