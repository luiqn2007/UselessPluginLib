...
import com.github.javaparser_new.ast.expr.LiteralExpr;
...
public class LiteralExprMetaModel extends ExpressionMetaModel {
    ...
    LiteralExprMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, LiteralExpr.class, "LiteralExpr", "com.github.javaparser_new.ast.expr", true, false);
    }
